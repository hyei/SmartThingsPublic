 ...
 *
 *  Reverse Z-Wave Door/Window Sensor v2
 *
 *  Author: SmartThings
 *  Date: 2013-11-3
 */
...
metadata {
	definition (name: "Reverse Z-Wave Door/Window Sensor v2", namespace: "hyei", author: "hyei", ocfDeviceType: "x.com.st.d.sensor.contact") {
